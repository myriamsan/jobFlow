error id: file:///C:/Users/myria/Documents/Angular/JobFlow/src/main/java/com/example/JobFlow/controller/UserController.java:com/example/JobFlow/entity/User#setNom#
file:///C:/Users/myria/Documents/Angular/JobFlow/src/main/java/com/example/JobFlow/controller/UserController.java
empty definition using pc, found symbol in pc: com/example/JobFlow/entity/User#setNom#
...
public class UserController {
    ...
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody User userDetails) {
        ...
        existingUser.setLas@@tName(userDetails.getLastName());
        existingUser.setPrenom(userDetails.getFirstName());
